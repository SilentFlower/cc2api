/// Claude Code 默认兼容版本。
pub const DEFAULT_CLAUDE_CODE_VERSION: &str = "2.1.156";
/// Claude Code 默认基础版本。
pub const DEFAULT_CLAUDE_CODE_VERSION_BASE: &str = "2.1.156";
/// Claude Code 2.1.156 抓包对应的构建时间。
pub const DEFAULT_CLAUDE_CODE_BUILD_TIME: &str = "2026-05-28T18:30:33Z";
/// Claude Code 2.1.156 使用的 Stainless SDK 版本。
...
/// Claude Code 2.1.156 的 event logging v2 路径。
